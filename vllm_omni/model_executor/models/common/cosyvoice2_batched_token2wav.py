...
"""Strict, state-explicit batching for CosyVoice2 Token2wav runtimes."""
...
CosyVoice2PromptFeatures = PromptFeatures
CosyVoice2BatchedState = BatchedToken2WavState
CosyVoice2BatchedToken2Wav = BatchedToken2Wav
cosyvoice2_state_shape_signature = state_shape_signature
...
__all__ = [
    ...
    "PromptFeatures",
    "cosyvoice2_state_shape_signature",
